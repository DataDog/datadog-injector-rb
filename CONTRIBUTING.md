...
Community contributions to Datadog projects for Ruby are welcome! See below for some basic guidelines.

## Want to request a new feature?

Many great ideas for new features come from the community, and we'd be happy to consider yours!

To share your request, you can [open a Github issue](https://github.com/DataDog/datadog-injector-rb/issues/new) with the details about what you'd like to see. At a minimum, please provide:
...
You may submit bug reports concerning the Datadog tracing library for Ruby by [opening a Github issue](https://github.com/DataDog/datadog-injector-rb/issues/new). At a minimum, please provide:
 ...
 - Any details you can share about your configuration including:
    ...
    - Versions of Datadog gems or otherwise packaged code
...
We welcome code contributions to the library, which you can [submit as a pull request](https://github.com/DataDog/datadog-injector-rb/pull/new/main). To create a pull request:

1. **Fork the repository** from https://github.com/DataDog/datadog-injector-rb
2. **Make any changes** for your patch.
3. **Write tests** that demonstrate how the feature works or how the bug is fixed.
4. **Update any documentation**, especially for new features.
5. **Submit the pull request** from your fork back to the latest revision of the `main` branch on https://github.com/DataDog/datadog-injector-rb.
